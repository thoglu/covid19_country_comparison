...
def load_data_daily_reports(timeseries_folder="timeseries/csse_covid_19_data/csse_covid_19_daily_reports"):
    ...
    not_supported=["Andorra", "Bahamas", "Cabo Verde", "Serbia", "Timor-Leste", "Kosovo", "Burma", "West Bank and Gaza", "North Macedonia", "Congo (Brazzaville)", "Congo (Kinshasa)", "Cote d'Ivoire", "Cruise Ship", "Diamond Princess", "Eswatini", "Montenegro", "Gambia", "Holy See"]
